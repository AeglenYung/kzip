...
namespace dirz
{
    public class DirzConfig : MyCommandConfig
    {
        ...
        public bool ListZip(string zFilename)
        {
            if (!File.Exists(zFilename))
            {
                Console.WriteLine($"'{zFilename}' is NOT found.");
                return false;
            }
        ...
        public override IReadOnlyCollection<SwitchCfgSetup> SwitchSetups =>
            new SwitchCfgSetup[] {
                ...
                new SwitchCfgSetup('q',"quiet",String.Empty,
                    getter:()=>false,
                    setter:()=>
                    {
                        Quiet = true;
        ...
        public DirzConfig(string helpHint) :
            base(helpHint, "")
        {
    ...
    static class ListEnvirHelper
    {
        ...
        public static IEnumerable<ZipItem> OrderEntryBy(
            this IEnumerable<ZipItem> source, DirzConfig cmd)
        {
        ...
        public static IEnumerable<ZipSum> OrderEntryBy(
            this IEnumerable<ZipSum> source, DirzConfig cmd)
        {
            switch (cmd.SortComparer)
            {
                case SortZipEntry.Size:
